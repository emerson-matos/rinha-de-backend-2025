(ns backend-payment-processor.components.mock-http
  (:require
   [backend-payment-processor.components.http :as h-com]
   [backend-payment-processor.protocols.http-client :as h-pro]
...
(defn add-responses [component response]
  (swap! (:responses component) merge response))
